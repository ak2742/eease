        ...
        <>
            <form onSubmit={onSubmit}>
                <div className="mb-3">
                    ...
                    <input type="text" minLength={3} name="name" value={credentials.name} onChange={onChange} className="form-control" id="name" required />
                </div>
                <div className="mb-3">
                ...
                <div className="mb-3">
                    ...
                    <input type="password" minLength={8} name="password" value={credentials.password} onChange={onChange} className="form-control" id="password" required />
                </div>
                <button disabled={
