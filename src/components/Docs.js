...
export default function Docs(props) {
    ...
    document.title = `Documentation | Eease`
        ...
        <div className="accordion accordion-flush" id="accordionFlushExample">
            <div className="accordion-item" style={myStyle}>
                ...
                <div id="flush-collapseOne" className="accordion-collapse collapse" aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                    <div className="accordion-body">At <strong>Eease</strong>, you can get letast updates coming from all over the world, can manipulate some text as you wish and along with these services for free, you can also get a cloud drive for all your important notes and store your data on internet for free.</div>
                </div>
            </div>
            <div className="accordion-item" style={myStyle}>
                ...
                <div id="flush-collapseTwo" className="accordion-collapse collapse" aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                    <div className="accordion-body">TextEease is a tool which can save your time in text decorations and makes it easy to you to use it. With textEease, you can count words and reading time of your text, remove extra spaces from your text, convert your text to uppercase and to lowercase. You can also copy a quite long text to your clipboard and then paste it where you want to.</div>
                </div>
            </div>
            <div className="accordion-item" style={myStyle}>
            ...
            <div className="accordion-item" style={myStyle}>
                ...
                <div id="flush-collapseFour" className="accordion-collapse collapse" aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                    <div className="accordion-body">At <strong>Eease</strong>, we try to provide you the most secured drive, where you can store your daily notes and get access to it from any device which is connected to the internet, by just logging in with few steps.</div>
                </div>
            </div>
        </div>
    )
